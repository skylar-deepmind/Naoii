  ...
  return (
    <footer className="bg-base-200 text-base-content border-t border-base-300">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="border-t border-base-300 mt-8 pt-6 text-center text-xs text-base-content/40 space-y-3">
          <p>© {new Date().getFullYear()} {dict.common.siteName} — {dict.footer.copyright}</p>
          <div className="flex items-center justify-center gap-4">
            <span className="text-base-content/30">{dict.footer.feedback}</span>
            ...
            {/* <a href="https://keet.io" target="_blank" rel="noopener noreferrer" className="btn btn-ghost btn-xs gap-1.5" title={dict.footer.joinKeet}>
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
